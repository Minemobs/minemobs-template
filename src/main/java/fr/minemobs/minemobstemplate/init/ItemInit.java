...
import fr.minemobs.minemobstemplate.objects.item.MinemobsItem;
...
public class ItemInit {
    ...
    public static final RegistryObject<Item> EXAMPLE_ITEM = ITEMS.register("example_item", MinemobsItem::new);
